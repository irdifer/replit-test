...
export function TrainingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M22 10v6M2 10v6M6 12h12" />
      <path d="M18 8c0-2.2-2-4-5-4H9.5C7.5 4 6 5 6 6.5V8c0 1 .5 2 2 2h7c2 0 3-1 3-2Z" />
      <path d="M18 15c0 2.2-2 4-5 4H9.5C7.5 19 6 18 6 16.5V15c0-1 .5-2 2-2h7c2 0 3 1 3 2Z" />
    </svg>
  );
}

export function DutyIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function MedicalIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" stroke="red" />
      <path d="M12 8v8M8 12h8" stroke="red" fill="none" />
    </svg>
  );
}
...
export function HospitalIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M9 13h6" />
      <path d="M21 10H3" />
      <text x="10" y="16" fontSize="5" fill="#0070f3">🏥</text>
    </svg>
  );
}
