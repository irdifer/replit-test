...
export default function StatsSummary({ stats }: StatsSummaryProps) {
  return (
    <section className="grid grid-cols-2 gap-3 mb-6 md:grid-cols-2 md:gap-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-4 flex flex-col items-center justify-center">
        <div className="text-neutral-500 text-sm font-medium mb-1">本月常訓次數</div>
        <div className="flex items-baseline">
          <span className="text-2xl font-bold text-green-600">
            {stats?.trainingCount || 0}
          </span>
          <span className="text-neutral-500 ml-1">次</span>
        </div>
      </div>
      
      <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-4 flex flex-col items-center justify-center">
        <div className="text-neutral-500 text-sm font-medium mb-1">本月公差次數</div>
        <div className="flex items-baseline">
