...
export default function AuthPage() {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row gap-0 overflow-hidden">
      {/* Hero Section */}
      <div className="bg-primary-500 text-white px-6 py-6 pb-16 md:p-8 flex-[0.4] flex flex-col justify-start md:justify-center items-center">
        <div className="max-w-md text-center">
          <h1 className="text-5xl md:text-5xl font-bold mb-1 md:mb-2 mt-5">🍀</h1>
      ...
      {/* Auth Forms */}
      <div className="flex-[0.6] px-6 py-0 pt-0 -mt-10 md:p-8 flex items-start md:items-center justify-center">
