...
export default function AuthPage() {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row gap-0 overflow-hidden">
      {/* Hero Section */}
      <div className="bg-primary-500 text-white px-6 py-10 pb-10 md:p-8 flex-[0.25] flex flex-col justify-center md:justify-center items-center">
        <div className="max-w-md text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-0 md:mb-2 mt-0">🍀</h1>
      ...
      {/* Auth Forms */}
      <div className="flex-[0.7] px-6 py-0 pt-4 md:p-8 flex items-start md:items-center justify-center">
